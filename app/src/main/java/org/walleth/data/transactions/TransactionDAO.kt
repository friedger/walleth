...
interface TransactionDAO {
    ...
    @Query("SELECT * FROM transactions WHERE (\"to\" = :address COLLATE NOCASE OR \"tokenTo\" = :address COLLATE NOCASE) AND chain=:chain ORDER BY creationEpochSecond DESC")
    ...
    @Query("SELECT * FROM transactions WHERE \"to\" COLLATE NOCASE IN(:addresses) OR  \"from\" COLLATE NOCASE IN(:addresses) OR \"tokenTo\" COLLATE NOCASE IN (:addresses)")
